...
export const documentViewerDirectoryPath = path.resolve(serverDirectoryPath, '../document-viewer');
export const documentViewerDistDirectoryPath = path.resolve(documentViewerDirectoryPath, './dist');

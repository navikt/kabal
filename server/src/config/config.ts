...
import { requiredEnvJson, requiredEnvString } from './env-var';
import { isDeployed, isLocal } from '@app/config/env';
...
const defaultVersion = isLocal ? new Date().toISOString() : undefined;
const localJwk: JWK = {};
...
export const AZURE_APP_JWK = requiredEnvJson<JWK>('AZURE_APP_JWK', isDeployed ? undefined : localJwk);
export const VERSION = requiredEnvString('VERSION', defaultVersion);

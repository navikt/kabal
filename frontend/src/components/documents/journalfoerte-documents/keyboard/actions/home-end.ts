...
export const home = (): DocumentPath => {
  if (getIsInVedleggList()) {
    return getDocumentPath(getAccessibleDocumentIndex(), setFocusedVedleggIndex(0));
  }

  return getDocumentPath(setAccessibleDocumentIndex(0), setFocusedVedleggIndex(-1));
};

  ...
  return (
    <>
      {columns.TEMA ? (
        ...
        >
          <span className="ellipsis select-none">{temaName}</span>
      ...
      {columns.AVSENDER_MOTTAKER ? (
        <div style={{ gridArea: Fields.AvsenderMottaker }} className="group ellipsis relative select-none">
...
const Saksnummer = ({ saksnummer }: SaksnummerProps) => {
  ...
  return (
    ...
    >
      <span className="ellipsis">{saksnummer}</span>

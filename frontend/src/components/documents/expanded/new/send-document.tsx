...
import { ConfirmFinishDocument } from './finish-document/confirm-finish-document';

interface Props {
  document: IMainDocument;
}

export const SendDocument = ({ document }: Props) => {
  ...
  return (
    <StyledSendDocument ref={ref}>
      <StyledSendButton onClick={toggleOpen} kompakt data-testid="document-send-button">
        <Send /> {buttonText}
      </StyledSendButton>

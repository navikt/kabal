...
const SHADOW_STYLE: React.CSSProperties = {
  boxShadow: 'var(--a-ax-border-neutral) 0 1px 0 0, black 0px 5px 5px -5px',
};
...
const ANGLED_DIV_CLASSES = 'ellipsis pr-3 absolute bottom-0 text-left origin-bottom-left';

  ...
  return (
    <HStack gap="2" align="center" className="[grid-area:title]">
      ...
      <Heading
        ...
        ref={ref}
        className={`${opacityClass} min-w-32 cursor-text whitespace-pre-wrap rounded-sm border border-ax-border-neutral-subtle px-0.5 empty:not-focus:text-text-subtle empty:not-focus:italic empty:not-focus:before:content-[attr(aria-placeholder)] focus:border-ax-border-focus`}
        onFocus={(e) => {

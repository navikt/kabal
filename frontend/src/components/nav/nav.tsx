...
export const Nav = () => (
  <HStack as="nav" height="100%" flexGrow="1" overflowX="auto" aria-label="Meny" data-testid="oppgaver-nav">
  ...
  return (
    <li className="flex items-center text-center">
      <NavLink
        ...
        data-testid={testId}
        className={({ isActive }) =>
          `flex w-full items-center gap-2 whitespace-nowrap border-transparent border-b-2 px-1 text-text-on-inverted transition-colors hover:border-ax-text-neutral-subtle ${isActive ? 'border-b-ax-text-accent' : ''}`
        }
      >
        {children}
      </NavLink>

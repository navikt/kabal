        ...
        <HStack gap="2" align="center" justify="space-between" wrap={false}>
          ...
          {canDeleteComment ? (
            <DeleteButton
              ...
              className="justify-start opacity-0 transition-opacity duration-200 focus:opacity-100 group-hover/comment:opacity-100"
            />
          ) : null}
        </HStack>
          ...
          <HStack gap="2" justify="space-between" align="start" wrap={false}>
            ...
            {canEditComment ? (
              <EditButton
                ...
                className="opacity-0 transition-opacity duration-200 focus:opacity-100 group-hover/comment:opacity-100"
              />
            ) : null}
          </HStack>
        )}

...
import { NestedFilterList, type NestedOption, OptionType } from '@/components/filter-dropdown/nested-filter-list';
import {
...
interface RegistreringshjemlerSelectProps {
  selected: string[];
  onChange: (selected: string[]) => void;
  includeNoneOption?: boolean;
}

export const RegistreringshjemlerSelect = ({
  selected,
  onChange,
  includeNoneOption = false,
}: RegistreringshjemlerSelectProps) => {

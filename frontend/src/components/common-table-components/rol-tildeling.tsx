...
import { RoleAccessedOpen } from '@app/components/common-table-components/open';
...
export const RolTildeling = ({ oppgave }: Props) => {
  ...
  const OpenButton = (
    <RoleAccessedOpen {...oppgave} medunderskriverident={oppgave.medunderskriver.employee?.navIdent ?? null} />
  );

...
import { SakertypeForSakerITR, Sakstype, SakstypeWithTrygderetten } from './filter-dropdowns/sakstype';
  ...
  columnKeys.map((key) => {
    switch (key) {
      ...
      case ColumnKeyEnum.TypeForSakerITR:
        return <SakertypeForSakerITR key={key} columnKey={key} tableKey={tableKey} />;

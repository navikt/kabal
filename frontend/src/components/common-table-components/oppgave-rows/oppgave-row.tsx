...
import { RoleAccessedOpen, YtelseAccessedOpen } from '@app/components/common-table-components/open';
        ...
        return (
          <Table.DataCell key={key}>
            {key === ColumnKeyEnum.OpenWithYtelseAccess ? (
              <YtelseAccessedOpen id={oppgave.id} ytelseId={oppgave.ytelseId} typeId={oppgave.typeId} />
            ) : (
              <RoleAccessedOpen
                id={oppgave.id}

...
import { isRegelverk } from '@/functions/is-rich-plain-text';
...
import { GOD_FORMULERING_TYPE, REGELVERK_TYPE, RichTextTypes } from '@/types/common-text-types';
import { LANGUAGE_NAMES, UNTRANSLATED } from '@/types/texts/language';
import type { IPublishedGodFormulering, IPublishedRegelverk, IPublishedRichText } from '@/types/texts/responses';

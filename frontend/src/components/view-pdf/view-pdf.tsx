  ...
  return (
    <Container minWidth={pdfWidth}>
      <Header>
        ...
        />
        <h1 className="ellipsis m-0 border-ax-border-neutral border-l py-1 pl-1 font-bold text-base">
...
const Container = ({ minWidth, children }: ContainerProps) => (
  ...
  >
    <BoxNew as="section" background="default" shadow="dialog" borderRadius="medium" position="relative" height="100%">
      {children}
    </BoxNew>
  </VStack>
);

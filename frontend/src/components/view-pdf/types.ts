...
interface INewDocumentPdfViewed {
  ...
  readonly archivedDocuments?: never;
...
interface IArchivedDocumentsPdfViewed {
  readonly newDocument?: never;
  readonly archivedDocuments: readonly IJournalfoertDokumentId[];
  readonly vedleggsoversikt?: never;
}
 ...
 */
export type IDocumentsPdfViewed = INewDocumentPdfViewed | IArchivedDocumentsPdfViewed | IVedleggsoversiktPdfViewed;

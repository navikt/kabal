...
export const AbbreviationsExplanation = () => (
  <ReadMore size="small" header="Forklaring av forkortelser">
    ...
    <BodyShort size="small" spacing>
      Tall og spesialtegn i kortformen kan være en måte å tydelig skille forkortelser fra ord eller unngå konflikter på.
      F.eks. <b>«k9»</b> til <b>«kapittel 9 i folketrygdloven»</b> og <b>«@om»</b> til <b>«omsorgspenger»</b>.
    </BodyShort>

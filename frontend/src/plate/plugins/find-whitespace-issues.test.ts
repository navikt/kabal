...
describe('findWhitespaceIssues', () => {
  ...
  describe('strictTrailing option', () => {
    ...
    it('should flag a single space as trailing when collapseLeading and strictTrailing are both true', () => {
      expect(
        findWhitespaceIssues(paragraph({ text: ' ' }), ELEMENT_PATH, {
  ...
  describe('spaces before punctuation', () => {
    ...
    it('should flag space before end square bracket', () => {
      expect(findWhitespaceIssues(paragraph({ text: 'hello ]' }), ELEMENT_PATH)).toMatchObject([
        { type: WhitespaceIssueType.SpaceBeforePunctuation },
      ]);
    });
    ...
    it('should detect whitespace-only placeholder at block level', () => {
      const element: TElement = {
        type: 'p',
        children: [{ text: 'hello' }, { type: 'placeholder', children: [{ text: ' ' }] }, { text: 'world' }],
      };
    ...
    it('should not flag trailing space inside placeholder with text', () => {
      const element: TElement = {
        type: 'p',
        children: [{ text: 'hello' }, { type: 'placeholder', children: [{ text: 'world ' }] }, { text: 'after' }],
      };

      expect(findWhitespaceIssues(element, ELEMENT_PATH)).toEqual([]);
    });

    it('should detect cross-boundary space before punctuation: placeholder trailing space + text starts with punctuation', () => {
      const element: TElement = {
        type: 'p',
        children: [{ text: 'hello' }, { type: 'placeholder', children: [{ text: 'world ' }] }, { text: '.' }],
      };
    ...
    it('should detect cross-boundary space before punctuation: whitespace-only placeholder + text starts with punctuation', () => {
      const element: TElement = {
        type: 'p',
        children: [{ text: 'hello' }, { type: 'placeholder', children: [{ text: ' ' }] }, { text: '.' }],
      };

      const issues = findWhitespaceIssues(element, ELEMENT_PATH);
    ...
    it('should delete full trailing range for punctuation when inline element has multiple trailing spaces', () => {
      const element: TElement = {
        type: 'p',
        children: [{ text: 'hello' }, { type: 'placeholder', children: [{ text: 'world  ' }] }, { text: '.' }],
      };
      ...
      expect(findWhitespaceIssues(element, ELEMENT_PATH)).toMatchObject([
        {
          ...
          anchor: { path: [0, 1, 0], offset: 5 },
          focus: { path: [0, 2], offset: 0 },
          deleteRanges: [{ anchor: { path: [0, 1, 0], offset: 5 }, focus: { path: [0, 1, 0], offset: 7 } }],
        },
      ]);
    });
  });

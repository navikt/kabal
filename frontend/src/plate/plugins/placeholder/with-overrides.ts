...
} from '@/plate/plugins/placeholder/delete';
import { getPlaceholderEntry, isPlaceholderInMaltekst } from '@/plate/plugins/placeholder/queries';
import type { MaltekstElement, PlaceholderElement } from '@/plate/types';

...
describe('cleanupWhitespaceIssues', () => {
  ...
  it('should remove space before end square bracket', () => {
...
describe('cross-boundary cleanup', () => {
  ...
  it('should remove space inside placeholder before punctuation in next text node', () => {
    const editor = createEditorWithInline([
      { text: 'hello' },
  ...
  it('should remove trailing space inside placeholder with text before punctuation', () => {
    const editor = createEditorWithInline([
      { text: 'hello' },
      { type: 'placeholder', children: [{ text: 'world ' }] },
      { text: '.' },
    ]);
    cleanupWhitespaceIssues(editor);
    expect(editor.children).toMatchObject([
...
describe('placeholder internal cleanup', () => {
  ...
  it('should handle all internal issues at once: leading + double, preserving trailing space', () => {
    const editor = createEditorWithInline([
      { text: 'before ' },
      { type: 'placeholder', children: [{ text: '  hello  world  ' }] },
      { text: ' after' },
  ...
  it('should handle cross-boundary and internal issues combined, preserving trailing space', () => {
    const editor = createEditorWithInline([
      { text: 'before  ' },
      { type: 'placeholder', children: [{ text: '  hello  world  ' }] },
      { text: '  after' },
  ...
  it('should remove single space inside whitespace-only placeholder', () => {
    const editor = createEditorWithInline([
      { text: 'before' },
      { type: 'placeholder', children: [{ text: ' ' }] },
      { text: 'after' },
  ...
  it('should clean whitespace-only placeholder in block with no direct text children', () => {
    const editor = createEditorWithInline([{ type: 'placeholder', children: [{ text: '  ' }] }]);
    cleanupWhitespaceIssues(editor);
    expect(editor.children).toMatchObject([
      {
        type: BaseParagraphPlugin.key,
        children: [{ text: '' }, { type: 'placeholder', children: [{ text: '' }] }, { text: '' }],
      },
    ]);
  });
});

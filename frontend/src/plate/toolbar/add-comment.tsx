...
export const CommentsButton = () => {
  ...
  const { setNewCommentSelection, newCommentSelection, dokumentId, setEditingComment } = useContext(SmartEditorContext);
  ...
  return (
    <ToolbarIconButton
      ...
      onClick={async () => {
        ...
        connectCommentThread(editor, newCommentSelection, comment.id);

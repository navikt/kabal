...
export const ANKE_TEMPLATES = ENVIRONMENT.isProduction
  ? BASE_ANKE_TEMPLATES
  : [...BASE_ANKE_TEMPLATES, EKSPEDISJONSBREV_TIL_TRYGDERETTEN_TEMPLATE];

const BASE_ANKE_I_TRYGDERETTEN_TEMPLATES = [
  GENERELT_BREV_TEMPLATE,
  NOTAT_TEMPLATE,
  ORIENTERING_OM_TILSVAR_TEMPLATE,
  ROL_QUESTIONS_TEMPLATE,
...
export const ANKE_I_TRYGDERETTEN_TEMPLATES = ENVIRONMENT.isProduction
  ? BASE_ANKE_I_TRYGDERETTEN_TEMPLATES
  : [...BASE_ANKE_I_TRYGDERETTEN_TEMPLATES, EKSPEDISJONSBREV_TIL_TRYGDERETTEN_TEMPLATE];

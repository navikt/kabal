...
import {
  ...
  SVAR_PAA_INNSYNSBEGJAERING_TEMPLATE,
...
export const KLAGE_TEMPLATES = ENVIRONMENT.isProduction
  ? [GENERELT_BREV_TEMPLATE, NOTAT_TEMPLATE, KLAGEVEDTAK_TEMPLATE, SVAR_PAA_INNSYNSBEGJAERING_TEMPLATE]
  : [
      GENERELT_BREV_TEMPLATE,
      NOTAT_TEMPLATE,
      KLAGEVEDTAK_TEMPLATE,
...
export const ANKE_TEMPLATES = ENVIRONMENT.isProduction
  ? [GENERELT_BREV_TEMPLATE, NOTAT_TEMPLATE, ANKEVEDTAK_TEMPLATE, SVAR_PAA_INNSYNSBEGJAERING_TEMPLATE]
  : [
      GENERELT_BREV_TEMPLATE,
      NOTAT_TEMPLATE,
      ANKEVEDTAK_TEMPLATE,
...
export const FINISHED_TEMLATES = [SVAR_PAA_INNSYNSBEGJAERING_TEMPLATE];

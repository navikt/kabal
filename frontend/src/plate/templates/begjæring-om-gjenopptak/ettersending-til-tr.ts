...
export const GJENOPPTAKSBEGJÆRING_ETTERSENDING_TIL_TR_SECTIONS: TemplateSections[] = [
  TemplateSections.TITLE,
  TemplateSections.INTRODUCTION_V2,
  TemplateSections.OM_ETTERSENDING_TIL_TR,
];

export const GJENOPPTAKSBEGJÆRING_ETTERSENDING_TIL_TR_METADATA: TemplateMetadata = {
...
export const getGjenopptaksbegjæringEttersendingTilTrTemplate = ({
  ...
  const richText: Value = [
    ...
    ...GJENOPPTAKSBEGJÆRING_ETTERSENDING_TIL_TR_SECTIONS.map((section) => createMaltekstseksjon(section)),

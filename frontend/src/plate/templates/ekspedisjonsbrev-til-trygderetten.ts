...
export const EKSPEDISJONSBREV_TIL_TRYGDERETTEN_SECTIONS: TemplateSections[] = [
...
export const EKSPEDISJONSBREV_TIL_TRYGDERETTEN_METADATA: TemplateMetadata = {
...
export const getEkspedisjonsbrevTilTrygderettenTemplate = (params: CreateTemplateParams): ISmartEditorTemplate => {
  const richText: Value = [
    ...
    ...EKSPEDISJONSBREV_TIL_TRYGDERETTEN_SECTIONS.map((section) => createMaltekstseksjon(section)),

...
export const handleDocumentFinishedEvent =
  (oppgaveId: string, userId: string, dispatch: Dispatch) => (event: DocumentFinishedEvent) => {
    handleJournalpostAddedEvent(oppgaveId, userId, dispatch)(event);

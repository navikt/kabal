...
} from '@/components/kvalitetsvurdering/v3/common/use-field-name';
...
const ANKE_AFTER_2027_FIELD_NAMES = {
  saksnummerHosTrygderetten: 'Saksnummer hos Trygderetten',
};
...
export const FIELD_NAMES = {
  ...
  [SaksTypeEnum.ANKE_AFTER_2027]: { ...DEFAULT_FIELD_NAMES, ...ANKE_AFTER_2027_FIELD_NAMES },
  [SaksTypeEnum.ANKE_I_TRYGDERETTEN_AFTER_2027]: {
    ...DEFAULT_FIELD_NAMES,
    ...ANKE_I_TRYGDERETTEN_FIELD_NAMES,
    ...ANKE_AFTER_2027_FIELD_NAMES,
  },
};

import { GOD_FORMULERING_TYPE, REGELVERK_TYPE, RichTextTypes, type TextTypes } from '@/types/common-text-types';
import type { ListGodFormulering, ListRegelverk, ListRichText } from '@/types/texts/common';
import type { IGodFormulering, IRegelverk, IRichText, IText, ListText } from '@/types/texts/responses';
